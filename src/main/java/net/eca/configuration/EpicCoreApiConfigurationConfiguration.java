...
public class EpicCoreApiConfigurationConfiguration {
	...
	public static final ForgeConfigSpec.ConfigValue<Boolean> OVERLAY_SHOW;
	static {
		...
		OVERLAY_SHOW = BUILDER.comment("Control the rendering of stamina bar and mana bar.控制精力条与魔力条的渲染。").define("overlay_show", true);
		BUILDER.pop();
